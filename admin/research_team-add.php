            ...
            <div class="col-12">
                ...
                <form name="regform" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="mb-3 mt-3">
                            <button type="submit" class="btn btn-primary btn-block" name="savebtn">Add Research Team member</button>
                        </div>
                </form>
                <!-- End Card Content -->
            </div>
        ...
        if (mysqli_num_rows($result) != 0) {
            ...
            try {
                $sql = 'INSERT INTO user_master 
                        ...
                        VALUES ("R","' . $regis_id . '","' . $passwordcombine . '","' . $firstname . '", "' . $ic . '", "' . $gender . '", "' . $dob . '", "' . $age . '", "' . $email . '", "' . $contact . '", "' . $address . '", "' . $city . '", "' . $state . '", "' . $zipcode . '","' . $created_at . '","' . $created_at . '")';
