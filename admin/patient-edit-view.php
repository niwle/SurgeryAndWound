...
<body>
    ...
    <div class="page-content" id="content">
        ...
        $um_id = $row['masterUserid_fk'];


        $imglocation = $row['progressImage'];
        $fulllocation = ("../uploads/patient_img/$um_id/$imglocation");
        ?>
        <!-- Page content -->
        <div class="row">
            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        ?>
                                                        <?php echo '<div class="d-flex justify-content-between">
