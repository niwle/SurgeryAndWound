                ...
                <div class="card shadow-sm rounded">
                    <div class="card-body">
                        <div class="d-flex mb-3">
                            <h5 class="card-title mr-auto"><?= ($_GET['t'] == base64_encode('p')) ? 'View Patient' : 'View Doctor'  ?> : <?php echo strtoupper($row["m_name"]) ?></h5>
                        </div>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="nav-info" role="tabpanel" aria-labelledby="info-tab">
                                    <table class="table table-bordered">
                                        ...
                                        ?>
                                            <tr>
                                                <th scope="row"><?= ($_GET['t'] == base64_encode('p')) ? 'Patient ID' : 'Doctor ID'  ?></th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type='button' data-feedback='<?= $row["feedback_text"] ?>' data-pbe='<?= $row["entryID"] ?>' data-toggle='modal' data-target='#editModal' name='{$no}modalPop' style='padding-left:20px; padding-right:20px' class='btn btn-outline-warning edit'>Edit</button>
