                                    ...
                                    while ($row2 = $result2->fetch_assoc()) : $emptyFeedback = false ?>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <?php echo $row2['feedback_text'] 
                                                        ?>
                                                        <?php //echo '<div class="d-flex justify-content-between"> <div>' . $row2['feedback_text'] . '</div> <div> <button class="btn btn-outline-warning" data-toggle="modal" data-target="#editModal" data-feedback="' . $row2['feedback_text'] . '" data-wif="' . $row2['f_id'] . '" style="border-radius: 10%;">Edit</button> <button class="btn btn-outline-danger delete-feedback"  data-feedback="' . $row2['feedback_text'] . '" data-wif="' . $row2['f_id'] . '" style="border-radius: 10%;">Delete</button> </div> </div>'; ?>
