...
if (isset($_POST["savebtn"])) {
    if (count($errors) == 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO user_master (m_name, email, password, created_at, updated_at) VALUES (?,?,?,?,?) ");
        $stmt->bind_param("sssss", $name, $email, $en_pass, $created_at, $created_at);
