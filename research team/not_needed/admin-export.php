                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="inputDoctor" name="type" class="custom-control-input type_option" value="d">
                                            <label class="custom-control-label" for="inputDoctor">Doctor</label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="inputPatient" name="type" class="custom-control-input type_option" value="p">
                                            <label class="custom-control-label" for="inputPatient">Patient</label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="inputResearch" name="type" class="custom-control-input type_option" value="r">
                                            <label class="custom-control-label" for="inputResearch">Research Team</label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="inputAll" name="type" class="custom-control-input type_option" value="" checked>
