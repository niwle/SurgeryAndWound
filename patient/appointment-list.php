...
<body>
    ...
    <div class="page-content" id="content">
        ...
        <?php
        $appointment_arr = [];
        $getAppointment = "SELECT a.*,  um.m_regis_id, um.m_name FROM appointment as a inner join user_master as um on um.m_id = a.doctor_id WHERE patient_id = '$sess_id' order by apoinment_date;;";
