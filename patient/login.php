...
<head>
    ...
    // echo "<script>Swal.fire({title: 'Error!', text: 'Please Enter a Email', type: 'error'})</script>";
    ?>
</head>
...
if (isset($_POST['loginbtn'])) {
    ...
    $check = $conn->prepare("SELECT * FROM user_master WHERE email = ? and m_type='p'");
