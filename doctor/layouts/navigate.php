        ...
        <div class="sidebabr-inner">
            <ul class="nav flex-column bg-white mb-0" id="metismenu">
                ...
                <li class="nav-item <?php if (stripos($_SERVER['REQUEST_URI'],'patient-list.php') !== FALSE) {echo 'mm-active';} ?>">
                    <a href="patient-list.php" class="nav-link" ><i class="fas fa-user-injured mr-3 fa-fw"></i>Patients Lists</a>
                </li>
                <li class="nav-item <?php if (stripos($_SERVER['REQUEST_URI'],'comment') !== FALSE) {echo 'mm-active';} ?>">
                    <a href="comment-list.php" class="nav-link" ><i class="fas fa-user-injured mr-3 fa-fw"></i>Comments Lists</a>
                </li>
                ...
                <li class="nav-item <?php if (stripos($_SERVER['REQUEST_URI'],'notification') !== FALSE) {echo 'mm-active';} ?>">
                    <a href="notification-list.php" class="nav-link" ><i class="fas fa-user-injured mr-3 fa-fw"></i>Notification Log</a>
                </li>
